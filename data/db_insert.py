...
with open("data/resources/exercises_database.json", "r") as data_source:
    ...
    for item in data:
        ...
        # db_record = models.Exercise(name=item["name"], instructions=item["instructions"])
        # db.add(db_record)
        ...
        # crud.add_media(db=db, media=models.Media(figure_img=item["images"]["image_1"], figure_url=item["images"]["image_1_url"], video=item["video"], exercise_id=exercise_id))
        # crud.add_media(db=db, media=models.Media(figure_img=item["images"]["image_2"], figure_url=item["images"]["image_2_url"], video=item["video"], exercise_id=exercise_id))
